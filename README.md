...
Ce TP introduit les concepts de base de :
- Développement de jeux 3D avec Unity
- Interaction utilisateur (clics, mouvement)
- Raycasting
- Collecte et stockage de données
- Introduction à l’IA et au Big Data
...
- Permettre le déplacement du joueur
- Permettre l’interaction avec des objets
...
- Ajouter une IA (ennemi ou agent intelligent)
